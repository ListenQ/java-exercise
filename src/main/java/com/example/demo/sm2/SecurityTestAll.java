...
//        System.out.println("公钥:" + sm2KeyVO.getPubHexInSoft() + "***"+sm2KeyVO.getPubHexInSoft().length());
//        System.out.println("私钥:" + sm2KeyVO.getPriHexInSoft() + "***" + sm2KeyVO.getPriHexInSoft().length());
//        //数据加密
